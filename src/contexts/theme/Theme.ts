			...
			RichTextEditor: {
				defaultProps: {
					labels: {
						...
						clearFormattingControlLabel: t('editor.control.clearFormatting'),
						...
						h4ControlLabel: t('editor.control.headings.4'),
						...
						codeControlLabel: t('editor.control.code'),
						subscriptControlLabel: t('editor.control.subscript'),
						superscriptControlLabel: t('editor.control.superscript'),
